...
\begin{titlepage}
		...
		\HRule \\[0.65cm]
		{ \huge \bfseries WEEABOT}\\[0.4cm] % Title of your document
		\HRule \\[1.5cm]
		...
		\begin{minipage}{0.4\textwidth}
			\begin{flushleft} \large
				\emph{\textbf{Auteurs:}}\\
				Alban \textsc{DESCOTTES}\\ % Your name
				Camille \textsc{FOSSIER}\\ % Your name
				Mohamed \textsc{BELDI}\\ % Your name
			\end{flushleft}
		\end{minipage}
		~
		\begin{minipage}{0.4\textwidth}
		...
		%	DATE SECTION
		%----------------------------------------------------------------------------------------
		\includegraphics[width=0.8\linewidth]{polytech.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
		{\large 5 mai 2018}\\[2cm] % Date, change the \today to a set date if you want to be precise
